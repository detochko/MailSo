...
class LinkFinderText extends \PHPUnit_Framework_TestCase
{
	...
	public function testCompileText()
	{
		...
		$this->assertEquals('777 ~http://domain.com~ ~domain.com~ ~user@domain.com~ &lt;&gt; 777', $this->object->CompileText(true, true));
		$this->assertEquals('777 ~http://domain.com~ ~domain.com~ ~user@domain.com~ <> 777', $this->object->CompileText(false, true));
		$this->assertEquals('777 ~http://domain.com~ domain.com ~user@domain.com~ &lt;&gt; 777', $this->object->CompileText(true, false));
		$this->assertEquals('777 ~http://domain.com~ domain.com ~user@domain.com~ <> 777', $this->object->CompileText(false, false));
	}
}
